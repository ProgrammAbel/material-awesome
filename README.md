...
### I no longer use this configuration, and thus, I am no longer maintaining it. Use HikariKnight's fork (it's better anyways)
...
```
git clone https://github.com/ProgrammAbel/material-awesome.git ~/.config/awesome
```
